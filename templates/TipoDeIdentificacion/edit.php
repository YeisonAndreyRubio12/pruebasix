...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $tipoDeIdentificacion->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $tipoDeIdentificacion->id), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column-responsive column-80">
        <div class="tipoDeIdentificacion form content">
            ...
            <fieldset>
                <legend><?= __('Edit Tipo De Identificacion') ?></legend>
                <?php
